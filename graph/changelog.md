...
- Added a boundary for large counterexamples: they should be treated as evidence of a wrong working hypothesis, plan, or earlier recheck rather than blindly expanding the task.
