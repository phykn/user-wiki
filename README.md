...
The result should make future work in that repository more natural: clearer entrypoints, sharper document roles, less generic explanation, decisions that follow the user's way, and evidence placed next to the claims it supports.
